...
F_A_0 = round((G_B * (-v_B_A) * 1000) / (t_w * M_B * X_A * Ф_A_B * 3600 ), 4)
...
S_T = round (((-d_H1 * k1 * C_A + (-d_H2) * k2 * C_Z) * V - W * (C_Y_0 * Сp_Y + C_A_0 * Cp_A) * (T-T_0)) /( K_T * (T - T_T)), 2)
print(f'S_T = {S_T} м^2\n')